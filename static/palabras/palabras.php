<?php
/**
 * Script para la generaci&oacute;n de CAPTCHAS
 *
...
class SimpleCaptcha {
    ...
    public $colors = array(
        ...
        array(7,163,55), // green
        array(214,22),  // red
    );

    /** Shadow color in RGB-array or null */
    public $shadowColor = array(0,0,0);// null; //array(0, 0, 0);
	...
	{
		// echo $_SESSION[$this->session_var] ;
	}
    ...
    protected function GetRandomCaptchaText($length = null) {
        ...
        $words  = "abcdefghijlmnopqrstvwyz1234567890ABCDEEFGHIJKLMNOPQRSTUVWXYZ";
        $vocals = "aeiouAEIOU";
